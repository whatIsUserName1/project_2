...
<script>
// echarts内部 用的是命名到处 export const 变量名 多个
// 正常导入 import{ 变量名,变量名} from 'echarts得到一个个导出来
// 目的: 但是我现在想要导入所有 形成一个对象来使用
// 语法 import * as 随便变量名 from 包名
// 模块内用命名导出的, 我把他们再收集起来形成对象, 放到echrats变量里
// import * as echarts from 'echarts'
// 基于准备好的dom，初始化echarts实例
// 生命周期中执行到这里时还没有渲染dom元素  所以下面的代码要放到mounted里面
// 模块内用命名导出的, 我把他们再收集起来形成对象, 放到echrats变量里
import * as echarts from 'echarts'
export default {
  name: 'my-home',
  ...
  methods: {
    ...
    setCurveChartFn() {
      ...
      // 数据源(模拟后台返回的数据)
      const aListAll = [
        { count: 36, date: '2022-10-10' },
        { count: 52, date: '2022-10-11' },
        { count: 78, date: '2022-10-12' },
        { count: 85, date: '2022-10-13' },
        { count: 65, date: '2022-10-14' },
        { count: 72, date: '2022-10-15' },
        { count: 88, date: '2022-10-16' },
        { count: 64, date: '2022-10-17' },
        { count: 72, date: '2022-10-18' },
        { count: 90, date: '2022-10-19' },
        { count: 96, date: '2022-10-20' },
        { count: 100, date: '2022-10-21' },
        { count: 102, date: '2022-10-22' },
        { count: 110, date: '22022-10-23' },
        { count: 123, date: '2022-10-25' },
        { count: 100, date: '2022-10-26' },
        { count: 132, date: '2022-10-27' },
        { count: 146, date: '2022-10-28' },
        { count: 200, date: '2022-10-29' },
        { count: 180, date: '2022-10-30' },
        { count: 163, date: '2022-10-31' },
        { count: 110, date: '2022-11-01' },
        { count: 80, date: '2022-11-02' },
        { count: 82, date: '2022-11-03' },
        { count: 70, date: '2022-11-04' },
        { count: 65, date: '2022-11-05' },
        { count: 54, date: '2022-11-06' },
        { count: 40, date: '2022-11-07' },
        { count: 45, date: '2022-11-08' },
        { count: 38, date: '2022-11-09' }
      ]
